...
# ══════════════════════════════════════════════════════════════════════════════
# Cache de Prompts com TTL (Ponto 1)
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
# Ferramentas Dinâmicas MCP com Auto-Binding de agent_id (Ponto 2)
# ══════════════════════════════════════════════════════════════════════════════
...
search_medical_compliance_tool = MCPRAGTool(
    name="search_medical_compliance_tool",
    description=(
    ...
    namespace_keys=["cfm", "regras"]
)

search_sop_tool = MCPRAGTool(
    name="search_sop_tool",
    description=(
...
search_clinic_has = MCPRAGTool(
    name="search_clinic_has",
    description=(
