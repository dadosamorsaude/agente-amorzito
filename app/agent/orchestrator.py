...
- **Join**: Use `id_atendimento` para relacionar as duas tabelas. A tabela `fl_qualidade_prontuarios_ia` é a principal; `fl_prontuarios_prescricoes` é complementar para detalhes de prescrições.
