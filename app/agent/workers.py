...
async def athena_agent_tool(query: str) -> str:
    """
...
async def compliance_agent_tool(query: str) -> str:
    """
...
async def audio_agent_tool(query: str) -> str:
    """
...
async def performance_agent_tool(query: str) -> str:
    """
